...
public class Estudiante {
    ...
    private String corEstu;
    private String ubiEstu;
    private String sexEstu;
    private String dirEstu;
    private String passEst;
    ...
    public String getDirEstu() {
        return dirEstu;
    }

    public void setDirEstu(String dirEstu) {
        this.dirEstu = dirEstu;
    }
    
    public String getSexEstu() {
        return sexEstu;
    }

    public void setSexEstu(String sexEstu) {
        this.sexEstu = sexEstu;
    }            
